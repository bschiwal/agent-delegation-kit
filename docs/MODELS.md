...
|---|---|---:|---:|---:|---|---:|---|---|
| GPT-6 Luna | OpenAI | $0.10 | $0.50 | **0.18** | economy | _unscored_ | unverified | yes |
...
| Grok 4.7 | xAI | $2.00 | $6.00 | **2.80** | standard | _unscored_ | unverified | yes |
...
| GPT-6 Sol | OpenAI | $2.00 | $10.00 | **3.60** | standard | _unscored_ | unverified | yes |
...
| Claude Opus 5.5 | Anthropic | $4.00 | $20.00 | **7.20** | premium | _unscored_ | unverified | yes |
...
**4 model(s) are unscored.** Automatic substitution never picks an unscored model, so they stay unused until you set `merit` in `registry/models.json` or name one explicitly in a role: GPT-6 Luna, Grok 4.7, GPT-6 Sol, Claude Opus 5.5.
