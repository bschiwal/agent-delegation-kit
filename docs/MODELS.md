...
Catalogue verified **2026-09-23**. Prices are USD per 1M tokens under GitHub Copilot usage-based billing.
...
|---|---|---:|---:|---:|---|---:|---|---|
| GPT-6 Luna | OpenAI | $0.10 | $0.50 | **0.18** | economy | 3 | yes | yes |
...
| Gemini 3.8 Flash | Google | $0.75 | $3.75 | **1.35** | standard | 3 | yes | yes |
...
| Grok 4.7 | xAI | $2.00 | $6.00 | **2.80** | standard | 3.5 | unverified | yes |
...
| Claude Opus 5.5 | Anthropic | $4.00 | $20.00 | **7.20** | premium | 5 | yes | yes |
...
|---|---|---|---|
| review | opus | Claude Opus 5.5 | quality-first |
| review-critical | opus | Claude Opus 5.5 | quality-first |
| deep-reasoning | opus | Claude Opus 5.5 | quality-first |
| triage | sonnet | Claude Sonnet 5 | balanced |
| implement | sonnet | Claude Sonnet 5 | balanced |
| bulk-edit | haiku | GPT-6 Luna | cheapest-viable |
| search | haiku | GPT-6 Luna | cheapest-viable |
| summarize | haiku | GPT-6 Luna | cheapest-viable |
| write-prose | haiku | GPT-6 Luna | cheapest-viable |

## Agents

| Agent | Role | Claude model | Copilot first choice |
|---|---|---|---|
| architect | deep-reasoning | opus | Claude Opus 5.5 |
| bulk-editor | bulk-edit | haiku | GPT-6 Luna |
| code-reviewer | review | opus | Claude Opus 5.5 |
| data-model-reviewer | review-critical | opus | Claude Opus 5.5 |
| debugger | deep-reasoning | opus | Claude Opus 5.5 |
| doc-writer | write-prose | haiku | GPT-6 Luna |
| implementer | implement | sonnet | Claude Sonnet 5 |
| log-triager | summarize | haiku | GPT-6 Luna |
