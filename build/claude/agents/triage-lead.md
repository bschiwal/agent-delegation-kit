...
model: sonnet
effort: medium
tools: 'Agent(architect, bulk-editor, code-reviewer, data-model-reviewer, debugger, doc-writer, implementer, log-triager, pr-scribe, repo-scout, security-reviewer, test-author), Read, Grep, Glob, TodoWrite'
maxTurns: 40
color: blue
---
