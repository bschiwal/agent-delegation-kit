...
<!-- BEGIN:agent-list -->
`architect` `bulk-editor` `code-reviewer` `data-model-reviewer` `debugger` `doc-writer` `implementer` `log-triager` `model-builder` `pbir-builder` `pr-scribe` `repo-scout` `security-reviewer` `test-author` `triage-lead`
<!-- END:agent-list -->
